...
export default function EditQuestionFormShortAnswer({ quizId, question, onSaved }) {
  const { user } = useAuth();
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const updateData = {
        ...
        correct_answer: expectedAnswer.trim() || "",
  ...
  return (
    <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 sm:p-8">
      <h2 className="text-xl font-semibold text-black dark:text-black">Edit Short Answer Question</h2>
      <p className="mt-1 text-sm text-black dark:text-black">Manual grading required for this question.</p>
      ...
      <form className="mt-6" onSubmit={handleSave}>
        <div className="grid grid-cols-1 gap-5">
          ...
          <div>
            <label htmlFor="expected" className="block text-sm font-medium text-black dark:text-black mb-1">
