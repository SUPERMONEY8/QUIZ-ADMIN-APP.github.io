...
- **sql.js**: Pure JavaScript SQLite library (no native compilation needed)
- **electron-builder**: Building and packaging Electron apps

## Database

This project uses **sql.js** - a pure JavaScript SQLite implementation that works perfectly with Electron 39+ without any native compilation issues.
