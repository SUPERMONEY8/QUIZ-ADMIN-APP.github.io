...
## 🎯 TASK: Connect Participant App to Admin App Database & Implement Code Entry
...
1. **Update Supabase Configuration**
   - Replace current Supabase credentials with these:
     - `VITE_SUPABASE_URL` = `https://dppbvokydkclcprsrpyv.supabase.co`
...
│                              │
│   ┌───────────────────┐    │
│   │   ABC123          │    │  (large, centered, uppercase)
│   └───────────────────┘    │
│                              │
│   [   Start Quiz   ]         │
│                              │
